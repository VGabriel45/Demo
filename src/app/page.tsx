      ...
      <GradientBackground>
        <header className="bg-white shadow-md">
          <div className="container mx-auto px-4 py-6 flex justify-between items-center">
            ...
            <nav>
              ...
              <button className="bg-gradient-to-r from-orange-500 to-orange-600 text-white px-4 py-2 rounded-full hover:from-orange-600 hover:to-orange-700 transition duration-300">Get Started</button>
            </nav>
          </div>
        </header>
        ...
        <main className="container mx-auto px-4 py-16">
          ...
          <section className="text-center mb-20">
            <h2 className="text-5xl font-bold text-gray-800 mb-6">Gamify Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-orange-600">Feedback Collection</span></h2>
            <p className="text-xl text-gray-600 mb-8">Make giving feedback fun and rewarding for your users</p>
            <div>
              <Script
                id="waitlist-css"
          ...
          <section id="features" className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
            <Card className="bg-white shadow-lg hover:shadow-xl transition duration-300 border-t-2 border-orange-400">
              ...
              <CardContent>
                <p className="text-gray-600">Turn giving feedback into a exciting quest and create challenges that keep users coming back for more.</p>
              </CardContent>
            </Card>
            <Card className="bg-white shadow-lg hover:shadow-xl transition duration-300 border-t-2 border-orange-400">
              <CardHeader>
              ...
              <CardContent>
                <p className="text-gray-600">Collect valuable, actionable feedback that helps improve your products and services.</p>
              </CardContent>
            </Card>
            <Card className="bg-white shadow-lg hover:shadow-xl transition duration-300 border-t-2 border-orange-400">
              <CardHeader>
              ...
              <CardContent>
                <p className="text-gray-600">Incentivize participation with a points system, badges, and crypto-rewards.</p>
              </CardContent>
            </Card>
          </section>
          ...
          <section className="text-center mx-auto max-w-4xl px-4 py-16">
