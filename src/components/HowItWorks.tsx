      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Effortless setup with Feedward. Create a feedback workflow, specify your questions or mini-challenges,
            choose rewards, and we handle the rest. Ensure your project's growth with valuable user feedback.
          </p>
        </div>
